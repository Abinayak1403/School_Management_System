<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTeachers.aspx.cs" Inherits="YourNamespace.ViewTeachers" %>
...
<body class="bg-light">
    <form id="form1" runat="server" class="container mt-5">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search by Name or Mobile" />
            </div>
            <div class="col-md-2">
        ...
        <asp:Label ID="lblMessage" runat="server" CssClass="fw-bold text-success d-block mb-3"></asp:Label>
